export default {
  ...
  knowledgeBase: {
    ...
    artifactTab: 'Parse Artifacts',
    artifactLoading: 'Loading artifacts...',
    artifactLoadError: 'Failed to load artifacts',
    artifactNoArtifacts: 'No parse artifacts yet. The document may still be processing.',
    artifactResolveImages: 'Resolve Images',
    artifactDownload: 'Download',
    artifactDownloadError: 'Failed to download artifact',
    artifactContentLoadError: 'Failed to load artifact content',
    artifactTooLarge: 'Artifact content is too large for inline preview, please download it.',
  ...
  settings: {
    ...
    canvasOAuth: {
      nav: 'Canvas LMS',
      title: 'Canvas LMS OAuth',
      description: 'Configure the Canvas instance and Developer Key.',
      viewDocs: 'View Docs',
      unconfigured: 'Canvas OAuth app credentials are not configured',
      configured: 'Canvas OAuth app is configured',
      expired: 'Canvas OAuth credentials expired',
      expiredDefault: 'Encryption key changed. Saved Client Secret cannot be decrypted. Please re-enter it.',
      reconfigure: 'Reconfigure',
      baseUrlLabel: 'Canvas instance URL (base_url)',
      baseUrlDesc: 'Root URL of the Canvas site, e.g. https://canvas.example.com or http://localhost:3080',
      baseUrlPlaceholder: 'https://canvas.example.com',
      clientIdLabel: 'Client ID',
      clientIdDesc: 'Client ID from the Canvas Developer Key created by a Canvas admin',
      clientIdPlaceholder: 'Enter Client ID',
      clientSecretLabel: 'Client Secret',
      clientSecretDesc: 'Developer Key Client Secret; encrypted and stored for this workspace',
      clientSecretPlaceholder: 'Enter Client Secret',
      saveHint: 'After saving, users can add Canvas data sources and authorize. Register WeKnora’s /api/v1/datasource/oauth/callback as a Redirect URI on the key.',
      saveBtn: 'Save Credentials',
      saveSuccess: 'Canvas OAuth credentials saved',
      saveFailed: 'Failed to save Canvas OAuth credentials',
    },
    weknoraCloud: {
      title: 'WeKnora Cloud',
  ...
  datasource: {
    ...
    noResources_canvas: 'No syncable Canvas courses found',
    ...
    noResourcesDesc_canvas: 'The current Canvas account returned no active courses, or cannot access their content',
    ...
    guideStep1_canvas: 'Confirm that the current Canvas account is enrolled in the course',
    guideStep2_canvas: 'Confirm that the course is active and contains accessible files',
    guideStep3_canvas: 'If it is still missing, go back, re-authorize, and load the list again',
    ...
    connectorDesc: {
      ...
      canvas: 'Sync course files from Canvas LMS via OAuth2',
    ...
    field: {
      ...
      canvasBaseUrl: 'Canvas instance URL',
      clientId: 'Client ID',
    ...
    oauthRevoke: 'Revoke',
    oauthAuthorizeHint: 'Click Authorize, sign in to Canvas, and approve access. The instance URL and Developer Key are configured by workspace admins under Settings → Canvas LMS.',
    oauthAuthorizeFailed: 'Failed to start authorization',
    oauthAuthorizedToast: 'Canvas authorization succeeded',
    oauthRevokedToast: 'Authorization revoked',
    oauthRevokeFailed: 'Failed to revoke authorization',
    oauthRequired: 'Please complete Canvas OAuth authorization first',
    oauthExpired: 'Canvas authorization expired',
    oauthExpiredDesc: 'Canvas rejected the current credentials. Go back, re-authorize, then load the course list again.',
    returnToReauthorize: 'Go back and re-authorize',
    canvasAppUnconfigured: 'Canvas app is not configured for this site',
    canvasAppRequired: 'Please contact the site administrator to configure the deployment environment',
    canvasAppRequiredHint: 'Instance URL, Client ID, and Client Secret are fixed by the site administrator. Users only authorize.',
    canvasAppGoSettings: 'Open admin settings',
