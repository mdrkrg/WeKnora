...
type RouterParams struct {
	...
	CanvasOAuthAdminHandler      *handler.CanvasOAuthAdminHandler
...
func NewRouter(params RouterParams) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		RegisterDataSourceOAuthRoutes(v1, params.DataSourceOAuthHandler, params.CanvasOAuthAdminHandler, rbacGuards)
